...
|           Before: A Wall of Text           |           After: Semantic Insights            |
| :----------------------------------------: | :-------------------------------------------: |
| ![Before Annotation](images/pdf_clean.jpg) | ![After Annotation](images/pdf_highlight.jpg) |

This transformation is guided by a clear, customizable color palette that maps directly to the core components of a research paper.

<p align="center">
  <img src="images/palette.png" alt="Color Palette Legend" width="500">
</p>
...
- **Semantic Highlighting:** Goes beyond keyword search to understand the _meaning_ of each sentence.
